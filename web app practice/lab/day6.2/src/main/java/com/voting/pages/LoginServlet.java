...
public class LoginServlet extends HttpServlet {
	...
	public LoginServlet() {
		...
		// when we write getServletContext() it will internally call
		// getServletConfig().getServletContext()
		
		// System.out.println("Context from default constructor"+getServletContext());
	}
	...
	public void init() throws ServletException {
		System.out.println("from init " + getServletConfig()); // not null - it will call toString() --> Fully qualified implementation class name - server specific
		System.out.println(getServletContext()); // not null --> Fully qualified implementation class name - server specific
