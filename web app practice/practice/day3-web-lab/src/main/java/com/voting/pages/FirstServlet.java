 ...
 */
/*
 * WC reads this annotation - run time, class level annotation,
 * at the app deployment time
 * WC creates Map
 * Key - /first : URL pattern
 * Value - fully qualified servlet className
 */
@WebServlet("/first") // equivalent to @WebServlet(value = "/first")
